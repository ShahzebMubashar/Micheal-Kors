...
URL = "https://www.michaelkors.com/women/clothing/"
...
async def scrape_michael_kors():
    async with async_playwright() as p:
        ...
        await page.goto(URL)
        print("Navigated to clothes page.")
    ...
    """)
        ...
        # Save to JSON
        with open("clothes.json", "w", encoding="utf-8") as f:
            json.dump(results, f, ensure_ascii=False, indent=2)

        print(f"Saved {len(results)} items to clothes.json.")
        await browser.close()
